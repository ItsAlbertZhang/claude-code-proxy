...
use claude_code_proxy::providers::codex::translate::request::{
    ResponsesInputItem, ResponsesRequest,
};
...
fn baseline_codex_public_api_forms_compile() {
    ...
    let _: fn(&str, &str, Vec<ResponsesInputItem>) -> bool = store_compaction;
    let _: fn(Option<&str>, &str, &[ResponsesInputItem]) -> bool = activate_compaction;
    let _: fn(Option<&str>, &ResponsesRequest) -> Option<ResponsesRequest> =
